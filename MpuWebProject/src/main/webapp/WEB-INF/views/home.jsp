					...
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							<a href="table.html">
								...
								<span class="hidden-tablet"> Tables</span>
							</a>
						</li>
						<li>
							<a href="calendar">
			...
			<div id="content" class="span10">
				...
				<div class="row-fluid">
					...
					<div class="widget span3 red" onTablet="span6" onDesktop="span3">
						...
						<h2>
							<span class="glyphicons pie_chart">
								<i></i>
							</span>
							Browsers
						</h2>
						...
						<div class="content">
							...
							<div class="browserStat big">
								<img src="<%=application.getContextPath()%>/resources/img/browser-chrome-big.png" alt="Chrome">
								<span>34%</span>
							</div>
							<div class="browserStat big">
								<img src="<%=application.getContextPath()%>/resources/img/browser-firefox-big.png" alt="Firefox">
								<span>34%</span>
							</div>
							<div class="browserStat">
								<img src="<%=application.getContextPath()%>/resources/img/browser-ie.png" alt="Internet Explorer">
								<span>34%</span>
							</div>
							<div class="browserStat">
								<img src="<%=application.getContextPath()%>/resources/img/browser-safari.png" alt="Safari">
								<span>34%</span>
							</div>
							<div class="browserStat">
								<img src="<%=application.getContextPath()%>/resources/img/browser-opera.png" alt="Opera">
								<span>34%</span>
							</div>
					...
					<div class="box black span4" onTablet="span6" onDesktop="span4">
						...
						<div class="box-content">
							<ul class="dashboard-list metro">
								<li class="green">
									<a href="javascript:;">
										<img class="avatar" alt="Dennis Ji" src="<%=application.getContextPath()%>/resources/img/avatar.jpg">
									</a>
									<strong>Name:</strong>
									Dennis Ji
									<br>
	...
	<footer>
		...
		<p>
			<span style="text-align: left; float: left">
				&copy; 2013
				<a href="http://themifycloud.com/downloads/janux-free-responsive-admin-dashboard-template/" alt="Bootstrap_Metro_Dashboard">JANUX
      	...
      	<div class="container">
      		<div class="row">
      			<div class="col-sm-12 col-lg-12">
      			 <script type="text/javascript" src="<%=application.getContextPath()%>/resources/js/script.js"></script>
      			</div>
