...
public class MainActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        axisButton=(Button)findViewById(R.id.axisButton);
    ...
    public void handleAxisButton(View v){


        Intent intent = new Intent(this, AxisActivity.class);
        intent.putExtra(AxisActivity.AccelerationSensorIndex, 0);
        intent.putExtra(AxisActivity.MagneticSensorIndex, 4);
